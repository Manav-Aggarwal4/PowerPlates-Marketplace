...
{% block content %}
  <h1 class="freshout">{% block title %}{% trans "Login" %}{% endblock %}</h1>
  {% if wizard.steps.current == 'auth' %}
    <p class="freshout">{% blocktrans %}Enter your credentials.{% endblocktrans %}</p>
  ...
  {% endif %}
  <p class="freshout">First Time User? <a href="{% url 'register' %}">Register here</a></p>
